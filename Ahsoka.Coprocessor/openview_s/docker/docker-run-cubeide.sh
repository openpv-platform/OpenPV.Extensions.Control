...
# container.
docker run -it --privileged -v /tmp/.X11-unix:/tmp/.X11-unix -v /home/`id -nu`:/home/`id -nu` -v /mnt/c/Projects:/projects -e DISPLAY=unix$DISPLAY $PULSE_SERVER_TCP_ENV  --entrypoint /home/user/entrypoint.sh --name Ahsoka.CubeIDE_UX openpv/openview_cubeide
